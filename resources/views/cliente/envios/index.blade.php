            ...
            <div class="card">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-pills p-2">
                        <li class="nav-item"><a class="nav-link active" href="#tab-curso" data-toggle="tab">Envíos en
                                Curso</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab-pendientes" data-toggle="tab">Envíos
                                Pendientes</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab-anteriores" data-toggle="tab">Completados</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#tab-cancelados" data-toggle="tab">Cancelados</a>
                        </li>
                        <li class="nav-item ml-auto pr-2"><a href="{{ route('envios.create') }}"
                                class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Nuevo Envío</a></li>
                    </ul>
                </div>
