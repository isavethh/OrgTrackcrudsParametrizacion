            ...
            <div class="card">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 250px;">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn btn-default" id="searchBtn"><i
                ...
                <div class="card-body p-0">
                    ...
                    <div id="empty-message" class="text-center p-4" style="display: none;">
                        <p class="text-muted">No hay direcciones guardadas. <a
                                href="{{ route('direcciones.create') }}">Crear una nueva dirección</a></p>
                    </div>
                </div>
                <!-- /.card-body -->
            </div>
            ...
            async function deleteDireccion(id) {
                try {
                    ...
                    if (!response.ok) {
                        ...
                        Swal.fire('Error', data.error || 'Error al eliminar la dirección', 'error');
                        return;
                    }

                    await loadDirecciones();
                } catch (error) {
                    Swal.fire('Error', 'Error al eliminar la dirección: ' + error.message, 'error');
                }
            }
