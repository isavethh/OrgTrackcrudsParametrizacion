        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        {{ isset($editId) ? 'Modificar Origen y Destino en el Mapa' : 'Seleccionar Origen y Destino en el Mapa' }}
                    </h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend"><span class="input-group-text"><i
                                    class="fas fa-location-arrow"></i></span></div>
                        <input type="text" id="hintDir" class="form-control"
                            value="Selecciona el punto de origen en el mapa" readonly>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="dirOrigen"
                                placeholder="Ej. Finca Orgánica La Esperanza" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="dirDestino"
                                placeholder="Ej. Planta Central de Procesamiento" required>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function trazarRuta(origenLat, origenLng, destinoLat, destinoLng) {
                ...
                try {
                    ...
                    Swal.fire('Advertencia', 'Error al calcular la ruta real: ' + error.message + '. Se mostrará una línea recta.', 'warning');
