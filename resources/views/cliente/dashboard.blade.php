    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
                ...
                <a href="{{ route('envios.index') }}" class="small-box-footer">Más información <i
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
                ...
                <a href="{{ route('direcciones.index') }}" class="small-box-footer">Más información <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
                ...
                <a href="{{ route('documentos.index') }}" class="small-box-footer">Más información <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
