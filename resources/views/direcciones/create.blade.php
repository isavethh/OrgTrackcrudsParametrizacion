    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('direcciones.store') }}" method="POST">
                ...
                <input type="hidden" name="rutageojson" id="rutageojson" value="">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.000001" name="origen_lat" id="origen_lat" class="form-control @error('origen_lat') is-invalid @enderror" value="{{ old('origen_lat') }}" required placeholder="-16.5000" readonly>
                                    @error('origen_lat')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.000001" name="origen_lng" id="origen_lng" class="form-control @error('origen_lng') is-invalid @enderror" value="{{ old('origen_lng') }}" required placeholder="-68.1500" readonly>
                                    @error('origen_lng')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.000001" name="destino_lat" id="destino_lat" class="form-control @error('destino_lat') is-invalid @enderror" value="{{ old('destino_lat') }}" required placeholder="-16.5000" readonly>
                                    @error('destino_lat')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.000001" name="destino_lng" id="destino_lng" class="form-control @error('destino_lng') is-invalid @enderror" value="{{ old('destino_lng') }}" required placeholder="-68.1500" readonly>
                                    @error('destino_lng')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
