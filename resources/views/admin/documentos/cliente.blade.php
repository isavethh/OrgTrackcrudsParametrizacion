            ...
            <div class="card card-primary card-tabs">
                <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="custom-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" id="tab-particiones" data-toggle="pill" href="#particiones"
                                role="tab">
...
@push('js')
    <script>
        // Usamos var para permitir la re-declaración segura si el script se carga múltiples veces
        var clienteIdDocumentos = {{ $id_cliente }};
        var token = localStorage.getItem('authToken')?.replace(/^\"+|\"+$/g, '') || null;
        ...
        async function cargarInfoCliente() {
            try {
                const res = await fetch(`${window.location.origin}/api/usuarios/${clienteIdDocumentos}`, { headers });
        ...
        async function cargarEnvios() {
            try {
                const res = await fetch(`${window.location.origin}/api/envios/usuario/${clienteIdDocumentos}`, { headers });
                                ...
                                <div class="document-card">
                                    ...
                                    <table class="document-table">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 20%; text-align: center;">Tipo de Empaque</th>
