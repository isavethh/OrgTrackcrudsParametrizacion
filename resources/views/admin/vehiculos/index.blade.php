...
@section('page-content')
    ...
    <!-- Modal crear/editar -->
    <div class="modal fade" id="vehiculoModal" tabindex="-1" role="dialog" aria-labelledby="vehiculoModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="vehiculoTipoVehiculo">Tipo de Vehículo <span
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" id="btnAddTipoVehiculo"
                            ...
                            <div class="form-group col-md-6">
                                <label for="vehiculoTipoTransporte">Tipo de Transporte <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" id="btnAddTipoTransporte"
    ...
    <!-- Modal eliminar -->
    <div class="modal fade" id="vehiculoDeleteModal" tabindex="-1" role="dialog" aria-labelledby="vehiculoDeleteLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="tipoVehiculoModal" tabindex="-1" role="dialog" aria-labelledby="tipoVehiculoModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="formTipoVehiculo">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="nuevoTipoVehiculoDescripcion" rows="2"
    ...
    <div class="modal fade" id="tipoTransporteModal" tabindex="-1" role="dialog" aria-labelledby="tipoTransporteModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="formTipoTransporte">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="nuevoTipoTransporteDescripcion" rows="2"
...
@push('js')
    ...
    <script>
        ...
        function renderVehiculos(data) {
            ...
            // Renderizar filas
            tablaBody.innerHTML = itemsToShow.map(v => {
        ...
        function changePage(page) {
            const totalItems = vehiculosCache.length;
            const totalPages = Math.ceil(totalItems / itemsPerPage);
        ...
        async function cargarVehiculos() {
            ...
            try {
                ...
                vehiculosCache = Array.isArray(vehiculos) ? vehiculos : [];
        ...
        async function abrirModalEditar(id, fila) {
            try {
                ...
                Swal.fire('Error', 'Error al cargar el vehículo: ' + e.message, 'error');
            }
        }
