            ...
            <form id="formCrear">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="crear_nombre" name="nombre" required maxlength="50" placeholder="Ej: Camión Articulado">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function editarRegistro(id) {
        // Como la API de index ya trae todo, podríamos buscar en la tabla, 
        // pero mejor hacemos GET para asegurar datos frescos si la API lo soporta.
        // Si no hay endpoint show, usamos los datos de la fila.
        // Asumimos que hay endpoint show o filtramos del array local si falla.
        
        // Intentamos GET primero
        /* 
           NOTA: Si la API no tiene endpoint show individual, 
           podemos buscar en los datos de la tabla:
           const data = tabla.row($(`button[data-id="${id}"]`).parents('tr')).data();
        */

        // Usaremos los datos de la fila para ser más rápidos y evitar errores si no hay endpoint show
