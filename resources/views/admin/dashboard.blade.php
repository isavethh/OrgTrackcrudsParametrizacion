...
<style>
    ...
    .metric-card.bg-info { background: #17a2b8; }
    .metric-card.bg-success { background: #28a745; }
    .metric-card.bg-warning { background: #ffc107; color: #222; }
    .metric-card.bg-danger { background: #dc3545; }
    .metric-card.bg-warning .metric-value, .metric-card.bg-warning .metric-label { color: #222; }
...
<script>
let enviosPorMesChart;
let estadosEnviosChart;
(function() {
    ...
    async function cargarEstadisticas() {
        try {
            ...
            if (enviosPorMesChart) enviosPorMesChart.destroy();
            if (labelsMeses.length) {
                enviosPorMesChart = new Chart(document.getElementById('enviosPorMesChart'), {
                    type: 'line',
                    data: {
                        labels: labelsMeses,
                        datasets: [{
            ...
            if (estadosEnviosChart) estadosEnviosChart.destroy();
            if (Object.keys(estados).length) {
                estadosEnviosChart = new Chart(document.getElementById('estadosEnviosChart'), {
                    type: 'doughnut',
                    data: {
            ...
            if (productosPorCategoriaChart) productosPorCategoriaChart.destroy();
            if (Object.keys(categoriaConteo).length) {
                productosPorCategoriaChart = new Chart(document.getElementById('productosPorCategoriaChart'), {
                    type: 'bar',
                    data: {
