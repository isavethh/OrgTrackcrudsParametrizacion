                ...
                <form id="formCrear">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="crear_tipo" name="tipo" required
                                        maxlength="50" placeholder="Ej: Tomate, Papa, Maíz">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="crear_variedad">Variedad <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="crear_variedad" name="variedad" required
                                        maxlength="50" placeholder="Ej: Roma, Criolla, Amarillo">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="crear_descripcion" name="descripcion" rows="2"
                                maxlength="150" placeholder="Información adicional (opcional)"></textarea>
                        </div>
                    </div>
                ...
                <form id="formEditar">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editar_tipo" name="tipo" required
                                        maxlength="50">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editar_variedad" name="variedad" required
                                        maxlength="50">
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editar_descripcion" name="descripcion" rows="2"
