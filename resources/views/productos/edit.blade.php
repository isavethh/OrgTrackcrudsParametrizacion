                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.001" name="peso_por_unidad" id="peso_por_unidad" class="form-control @error('peso_por_unidad') is-invalid @enderror" value="{{ old('peso_por_unidad', $producto->peso_por_unidad) }}" required min="0.001">
