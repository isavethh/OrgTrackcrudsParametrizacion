...
<div class="bg-white shadow-lg w-64 flex-shrink-0">
    ...
    <div class="p-6 border-b border-gray-200">
        <h1 class="text-xl font-bold text-blue-600">OrgTrack</h1>
    </div>
    ...
    <nav class="mt-6">
        <div class="px-3">
            ...
            <a href="{{ route('profile') }}" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors {{ request()->routeIs('profile') ? 'bg-blue-50 text-blue-600' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
