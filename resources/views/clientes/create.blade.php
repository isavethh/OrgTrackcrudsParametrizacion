                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="direccion_entrega" id="direccion_entrega" class="form-control @error('direccion_entrega') is-invalid @enderror" value="{{ old('direccion_entrega') }}">
