                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="capacidad_carga" id="capacidad_carga" class="form-control @error('capacidad_carga') is-invalid @enderror" value="{{ old('capacidad_carga', $vehiculo->capacidad_carga) }}">
