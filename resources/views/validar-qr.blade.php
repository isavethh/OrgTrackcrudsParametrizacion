            ...
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                <div class="card card-primary card-outline validation-card">
                    <div class="card-body text-center p-4 p-md-5">
                        <div class="mb-4">
                            <div class="icon-circle d-inline-flex align-items-center justify-content-center bg-primary rounded-circle"
                        ...
                        <div class="w-100">
                            ...
                            <p class="text-muted mb-4">Ingrese el código de acceso proporcionado para ver el documento
                            </p>
                        </div>

                        <div class="form-group">
                            <input type="text" id="inputCodigo" class="form-control form-control-lg code-input"
                ...
                btnMostrarFirma.addEventListener("click", () => {
                    ...
                    setTimeout(() => {
                        ...
                        const startDraw = (e) => {
                            ...
                            ctx.beginPath();
                            ctx.moveTo(x, y);
                            ctx.lineTo(x, y); // Dibujar un punto inicial
                            ctx.stroke();
